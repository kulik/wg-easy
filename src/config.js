...
module.exports.WG_DEFAULT_ADDRESS = process.env.WG_DEFAULT_ADDRESS || '10.8.x.x';
...
iptables -t nat -A POSTROUTING -s ${module.exports.WG_DEFAULT_ADDRESS.replaceAll('x', '0')}/16 -o ${module.exports.WG_DEVICE} -j MASQUERADE;
...
iptables -t nat -D POSTROUTING -s ${module.exports.WG_DEFAULT_ADDRESS.replaceAll('x', '0')}/16 -o ${module.exports.WG_DEVICE} -j MASQUERADE;
